component {
    ...
    */
     ...
     * 
     * @return boolean                  True if the request has a valid reload URL parameter, false otherwise.
     */
    ...
    /**
     * Determines if the specified target path is an unhandled request.
     * Override this method to dynamically exclude specific requests from being handled by FW/1.
     * By default, FW/1 uses the unhandledExtensions and unhandledPaths configuration items.
     * To include your own custom paths along with the default checks, write a test like:
     * return super.isUnhandledRequest(targetPath) || myCustomChecks();
     * 
     * @targetPath string              The target path to check.
     * 
     * @return boolean                 True if the target path is an unhandled request, false otherwise.
     */
    public boolean function isUnhandledRequest(string targetPath) {
        ...
        // For unhandledPaths, we make the list into an escaped regular expression so we match on subdirectories.
        // This means that '/myexcludepath' will match '/myexcludepath' and all subdirectories.
        return listFindNoCase(variables.framework.unhandledExtensions, listLast(targetPath, '.')) ||
     ...
     * 
     * @path string                   The path of the layout.
     * @body string                   The body content to be rendered inside the layout.
     * 
     * @return string                 The rendered UI.
     */
     ...
     * called from Java.  
     * Can be used with external rendering engines, for example.
     * 
     * @methodNames array              An array of method names to create proxies for.
     * 
     * @return struct                  A struct containing the created proxies, with method names as keys.
     */
    ...
    */
     ...
     * 
     * @cfc any                         The bean CFC.
     * @property string                 The property that was being set when the error occurred.
     * @rc struct                       The request context structure.
     * @prc struct                      The private request context structure.
     * 
     * @return void
     */
    ...
    /**
     * This method can be overridden if you want to take some actions when the
    ...
    /**
     * This method is not intended to be overridden and is automatically deleted for CFC requests.
     * It handles the execution of controllers, rendering of views and layouts, and setting up the response wrapper.
     * If OPTIONS support is enabled and an OPTIONS request is made with at least one possible match,
     * it bypasses normal controllers and renders the appropriate headers and data.
     * Otherwise, it executes the before, item, and after controllers in order,
     * and then renders the view and layout based on the request context.
     * The output is written to the response.
     * 
     * @targetPath string              The target path for the request.
     * 
     * @return any
     */
    ...
    /**
     * If you override onRequestEnd(), make sure to call super.onRequestEnd()
     * if you want tracing functionality to continue working.
     */
    ...
    /**
     * Populates the properties of a CFC with values from the request context.
     * 
     * @cfc any                             The CFC to populate.
     * @keys string                         The keys to populate. If empty, all keys in the request context will be used.
     * @trustKeys boolean                   Determines whether to trust the keys in the request context. If set to true, only keys that match the properties of the CFC will be used.
     * @trim boolean                        Determines whether to trim the values before populating the properties.
     * @deep boolean                        Determines whether to populate nested properties of the CFC.
     * @properties any                      Additional properties to populate the CFC with. If empty, the request context will be used.
     * 
     * @return any                          The populated CFC.
     */
    ...
    /**
     * Processes the routes and matches the given path against the routes.
     * 
     * @path string                        The path to match against the routes.
     * @routes array                       The routes to process.
     * @httpMethod string                  The HTTP method to use for matching. Defaults to the current request method.
     * 
     * @return struct                      A struct indicating whether a route was matched or not.
     */
     ...
     * 
     * @action string                      The action to redirect to.
     * @preserve string                    Determines whether to preserve flash scope data. Defaults to 'none'.
     * @append string                      Determines which request context variables to append to the URL query string. Defaults to 'none'.
     * @path string                        The base URL path. Defaults to the magicBaseURL variable.
     * @queryString any                    The query string parameters to include in the URL. Defaults to an empty string.
     * @statusCode string                  The HTTP status code to use for the redirect. Defaults to '302'.
     * @header string                      The custom header to include in the redirect response. Defaults to an empty string.
     * 
     * @return void
     */
     ...
     * @return void
     */
    public void function redirectCustomURL( 
        string uri, 
        string preserve = 'none', 
        string statusCode = '302', 
        string header = '' 
     ...
     * Arguments are deprecated in favor of the builder syntax as of FW/1 4.0.
     * 
     * @type string                        The type of data to render. Defaults to an empty string.
     * @data any                           The data to render. Defaults to an empty string.
     * @statusCode numeric                 The HTTP status code to use for the response. Defaults to 200.
     * @jsonpCallback string               The JSONP callback function name. Defaults to an empty string.
     * 
     * @return any                         The rendered data.
     */
    ...
    /**
     * Returns a builder object to support nicer rendering syntax.
     * 
     * @return any                         The builder object.
     */
    ...
    /**
     * Sets the default value for a session variable.
     *
     * @keyname string                      The name of the session variable.
     * @defaultValue any                    The default value to set.
     * 
     * @return void
     */
    public void function sessionDefault( 
        string keyname, 
        any defaultValue 
    ) {
     ...
     *
     * @keyname string                      The name of the session variable to delete.
     * 
     * @return void
     */
     ...
     *
     * @keyname string                      The name of the session variable to check.
     * 
     * @return boolean                      Returns true if the session variable exists, false otherwise.
     */
    ...
    /**
     * Locks the session scope and executes a callback function within the lock.
     * 
     * @callback function                  The callback function to be executed within the lock.
     * 
     * @return void
     */
    ...
    /**
     * Reads a value from the session scope.
     *
     * @keyname string                      The name of the session variable to read.
     * 
     * @return any                          The value of the session variable.
     */
    ...
    /**
     * Writes a value to the session scope.
     *
     * @keyname string                      The name of the session variable to write.
     * @keyvalue any                        The value to write to the session variable.
     * 
     * @return void
     */
     ...
     * about your bean factory.
     * 
     * @beanFactory any                    The bean factory to be used by the framework.
     * 
     * @return void
     */
    ...
    /**
     * Use this method to override the default layout.
     * 
     * @action string                       The action to set as the layout.
     * @suppressOtherLayouts boolean        (optional) Whether to suppress other layouts. Defaults to false.
     * 
     * @return void
     */
     ...
     * about your subsystem-specific bean factory.
     * 
     * @subsystem string                   The name of the subsystem.
     * @factory any                        The subsystem-specific bean factory.
     * 
     * @return void
     */
    ...
    /**
     * Override this method to provide application-specific initialization.
     * If you want the framework to use a bean factory and autowire controllers and services,
     * call setBeanFactory(factory) in your setupApplication() method.
     ...
     *
     * This method is called during the application initialization process to set up the environment for the application.
     * It takes the environment as an argument and performs any necessary setup tasks specific to that environment.
     *
     * @env string                          The environment to set up.
     * 
     * @return void
     */
    ...
    /**
     * Override this method to provide request-specific initialization.
    ...
    /**
     * Override this method to provide request-specific finalization.
     *
     * @rc struct                          The request context struct.
     * @prc struct                         The private request context struct.
     * 
     * @return void
     */
    ...
    /**
     * Override this method to provide session-specific initialization.
     *
     * @return void
     */
     ...
     *
     * @output string                      The output format for tracing. Defaults to 'html'.
     * 
     * @return void
     */
    ...
    /**
     * Use this method to override the default view.
     *
     * @action string                       The action to set as the view.
     * 
     * @return void
     */
     ...
     *
     * @return boolean                      True if using subsystems, false otherwise.
     */
     ...
     *
     * @path string                        The path of the view.
     * @args struct                        (optional) The arguments to pass to the view.
     * @missingView any                    (optional) The value to return if the view is missing.
     * 
     * @return any                         The UI generated by the named view.
     */
    ...
    /**
     * Call this to set up mappings for modules.
     * in Application.cfc, call as follows:
     *   this.mappings = moduleMappings( "qb, supermod" );
     *   this.mappings = moduleMappings( [ "mod1", "mod2"], "modules" );
     *
     * @modules any                        The modules to create mappings for.
     * @modulePath string                  (optional) The path to the modules directory. Defaults to "modules".
     * 
     * @return struct                      The module mappings.
     */
     ...
     * you set up moduleMappings() using the function above.
     *
     * @frameworkPath string               (optional) The location of the FW/1 framework. Defaults to "framework".
     * 
     * @return void
     */
    ...
    /**
     * Helper function to allow mixins.
     *
     * @return struct                      The variables struct.
     */
    private struct function __vars() {
        return variables;
    }
